      ...
      <div className='relative z-10 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4'>
        <div>
          ...
          <div className='flex flex-wrap items-center gap-3 sm:gap-4 mt-4'>
            <span className='flex items-center gap-1.5 text-xs sm:text-sm text-white/90 bg-white/10 px-3 py-1.5 rounded-full backdrop-blur-sm border border-white/10'>
        ...
        {/* Stats preview card */}
        <div className='hidden lg:flex items-center gap-3 bg-white/10 backdrop-blur-md rounded-xl p-4 border border-cyan-400/20'>
